  ...
  module Http
    ...
    class NetHttp
      ...
      def fetch_with_redirects(uri, max, read_timeout, open_timeout, depth, headers)
        raise IalaFetcher::Http::TooManyRedirects, uri.to_s if depth >= max
        ...
        when Net::HTTPRedirection
          ...
          raise IalaFetcher::Http::BadStatus, "HTTP #{res.code} for #{uri}"
        end
      rescue Net::ReadTimeout, Net::OpenTimeout
        raise IalaFetcher::Http::Timeout, uri.to_s
      end
